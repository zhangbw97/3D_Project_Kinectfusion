...
namespace cuda {
    ...
    __global__
    void update_tsdf_3d_kernel(const PtrStepSz<float> depth_image,
    ...
    void surface_reconstruction_3d(const cv::cuda::GpuMat& depth_image,
                                ...
                                const Eigen::Matrix4f& extrinsic)
    {
        ...
        update_tsdf_3d_kernel<<<blocks, threads>>>(depth_image, color_image,
